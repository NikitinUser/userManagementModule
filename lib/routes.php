...
Route::get('/getPageUserInfo', [UserManagementController::class, 'getPageUserInfo'])->name('getPageUserInfo')->middleware('web');

Route::post('addUser', [UserManagementController::class, 'addNewUser'])->middleware('web');
Route::post('removeUser', [UserManagementController::class, 'removeUser'])->middleware('web');

Route::post('changeRoleUser', [UserManagementController::class, 'changeRoleUser'])->middleware('web');
 ...
 * Permissions
 */
Route::get('/getPageAllPermissions', [PermissionController::class, 'getPageAllPermissions'])->name('getPageAllPermissions')->middleware('web');
